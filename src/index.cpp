...
// Lightweight directory scan - only gets paths and modification times
...
// Create comprehensive file info (moved from index_file function)
...
void reindex_new_or_modified(
  ...
  std::unordered_map<std::string, LightFileInfo> current_files;
